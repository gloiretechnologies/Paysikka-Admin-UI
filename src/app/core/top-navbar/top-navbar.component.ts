...
export class TopNavbarComponent {
  opened!: Boolean;
  title!: any;
  constructor(private confirmBoxEvokeService: ConfirmBoxEvokeService, private toast: NgToastService, private navService: SideNavService, private router: Router, private activeRoute: ActivatedRoute,private modalService: NgbModal) {
  ...
  adminProfile(){
   const profileData:any ={
    ...
    const modalRef = this.modalService.open(AdminProfileComponent,profileData);
    modalRef.componentInstance.profileData = profileData;
  }
  ngDoCheck() {
